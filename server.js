  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.fontSize(8).fillColor('#999999').text(
        `${vendor.boutiqueName || 'Boutique'}${vendor.phone ? ' · ' + vendor.phone : ''} — Facture générée automatiquement par KAZAP`,
        { align: 'center' }
      );
...
// qu'une commande passe au statut 'confirmed'. Ne doit jamais faire échouer la
